...
ActiveRecord::Schema.define(version: 20191127085529) do

  create_table "admission_records", id: :integer, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
  ...
  create_table "apply_sets", id: :integer, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
  ...
  create_table "interview_scores", id: :integer, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.integer "student_id", comment: "学生ID"
    t.integer "student_class_id", comment: "学生班级ID"
  ...
  create_table "permissions_roles", id: :integer, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.integer "permission_id"
    t.integer "user_id"
    t.index ["permission_id"], name: "index_permissions_roles_on_permission_id"
    t.index ["user_id"], name: "index_permissions_roles_on_user_id"
  end
  ...
  create_table "student_classes", id: :integer, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.string "name"
  ...
  create_table "student_documents", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.string "name"
    t.string "name_en"
    t.string "id_card"
  ...
  create_table "written_applies", id: :integer, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.integer "student_id", comment: "学生ID"
  ...
  create_table "written_scores", id: :integer, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.integer "student_id", comment: "学生ID"
    t.integer "student_class_id", comment: "学生班级ID"
